        ...
        >
            ...
            <ContainerScroll
                titleComponent={
                    ...
                    >
                        {/* Label */}
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-xs font-medium tracking-wider uppercase text-muted-foreground mb-6">
                            Our Capabilities
                        </div>
                        ...
                        <span className="block text-5xl md:text-[5.5rem] font-black leading-none bg-gradient-to-r from-blue-400 via-violet-400 to-purple-500 bg-clip-text text-transparent">
                            Modern Web Design
                        </span>
